...
public class SearedPipeAttachmentModel extends BakedModelWrapperWithData {
        ...
        private static final ModelProperty<SearedPipeModelData> PIPE_PROPERTY = new ModelProperty<>();
	...
	protected ModelData.Builder gatherModelData(Builder builder, BlockAndTintGetter world, BlockPos pos, BlockState state,
		...
		SearedPipeModelData data = new SearedPipeModelData();
		...
		data.setEncased(SearedPipeBlock.shouldDrawCasing(world, pos, state));
        ...
        public List<BakedQuad> getQuads(BlockState state, Direction side, RandomSource rand, ModelData data,
                ...
                if (data.has(PIPE_PROPERTY)) {
                        SearedPipeModelData pipeData = data.get(PIPE_PROPERTY);
        ...
        private void addQuads(List<BakedQuad> quads, BlockState state, Direction side, RandomSource rand, ModelData data,
                        SearedPipeModelData pipeData, RenderType renderType) {
        ...
        private static class SearedPipeModelData {
                private AttachmentTypes[] attachments;
                private boolean encased;
                private BakedModel bracket;

                public SearedPipeModelData() {
