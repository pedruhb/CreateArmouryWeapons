...
public abstract class BlockSearedSpoutingBehaviour {

	private static final Map<ResourceLocation, BlockSearedSpoutingBehaviour> BLOCK_SPOUTING_BEHAVIOURS = new HashMap<>();

	public static void addCustomSpoutInteraction(ResourceLocation resourceLocation, BlockSearedSpoutingBehaviour movementBehaviour) {
		BLOCK_SPOUTING_BEHAVIOURS.put(resourceLocation, movementBehaviour);
	}

	public static void forEach(Consumer<? super BlockSearedSpoutingBehaviour> accept) {
	 ...
	 */
	public abstract int fillBlock(Level world, BlockPos pos, SearedSpoutBlockEntity spout, FluidStack availableFluid, boolean simulate);
