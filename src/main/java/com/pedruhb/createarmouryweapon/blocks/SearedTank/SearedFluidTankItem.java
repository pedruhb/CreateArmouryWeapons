...
public class SearedFluidTankItem extends BlockItem {

	public SearedFluidTankItem(Block p_i48527_1_, Properties p_i48527_2_) {
	...
	protected boolean updateCustomBlockEntityTag(BlockPos p_195943_1_, Level p_195943_2_, Player p_195943_3_, ItemStack p_195943_4_, BlockState p_195943_5_) {
		...
		if (nbt != null) {
			...
			if (nbt.contains("TankContent")) {
				...
				if (!fluid.isEmpty()) {
					fluid.setAmount(Math.min(SearedFluidTankBlockEntity.getCapacityMultiplier(), fluid.getAmount()));
