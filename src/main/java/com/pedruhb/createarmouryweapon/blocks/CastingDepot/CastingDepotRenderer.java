...
public class CastingDepotRenderer extends SafeBlockEntityRenderer<CastingDepotBlockEntity> {
	...
	@Override
	protected void renderSafe(CastingDepotBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
	...
	public static void renderItemsOf(SmartBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		int light, int overlay, CastingDepotBehaviour depotBehaviour) {
